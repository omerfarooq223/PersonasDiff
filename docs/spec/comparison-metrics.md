# Comparison Metrics Specification (v1.0.0)

## Overview

This document describes the comparison metrics implemented in the comparison engine, including their algorithms, thresholds, and interpretation guidelines. All metrics are designed to be deterministic, explainable, and non-causal.
