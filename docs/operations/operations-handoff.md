# Operational Architecture & Maintenance Guide
...
| `packages/db`         | Database Layer               | PostgreSQL pool, migrations, repositories for runs, evidence, resilience, and audit.                 |
...
- **Local Development Guide:** [`docs/runbooks/local-development.md`](../runbooks/local-development.md)
- **Staging Health Check:** [`docs/runbooks/staging-health-check.md`](../runbooks/staging-health-check.md)
- **Incident Response Runbook:** [`docs/runbooks/incident-response-runbook.md`](../runbooks/incident-response-runbook.md)
- **Data Retention & Privacy Map:** [`docs/security/privacy-data-map.md`](../security/privacy-data-map.md)
